...
contract TBridge2 is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    uint256 public thresholdLimit = 100 * 10**6;
    ...
    */
    function withdrawTokens(address token, address receiver, uint256 amount) external {
        ...
        require(amount > 0, "AMOUNT_CANT_BE_ZERO");
        address user = msg.sender;
        require(amount <= tokenDeposited[token][user], "CANT_WITHDRAW_MORE_THAN_DEPOSITED");
